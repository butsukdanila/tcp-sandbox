...
int xs_frame_send(int sock, const xs_frame_t * frame);
int xs_frame_recv(int sock, xs_frame_t * frame);
int xs_frame_xchg(int sock, const xs_frame_t * req, xs_frame_t * rsp);
